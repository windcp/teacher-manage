...
(function (i) {
            ...
            clearOldFirstNode: function (c, a) {
                ...
                if (a && a.length != 0) {
                    ...
                    for (h = 0, j = a.length; h < j; h++) {
                        var g = a[h];
                        if (!d[g.parentTId]) {
                            var i = g.getParentNode();
                            d[g.parentTId] = i === null ? e.getRoot(c) : g.getParentNode()
                        }
                        f.showNode(c, g, b)
                    }
                    for (var k in d)a = d[k][c.data.key.children], f.setFirstNodeForShow(c, a), f.setLastNodeForShow(c, a)
                }
                ...
                if (a && a.length != 0) {
                    ...
                    for (h = 0, j = a.length; h < j; h++) {
                        var g = a[h];
                        if ((g.isFirstNode || g.isLastNode) && !d[g.parentTId]) {
                            var i = g.getParentNode();
                            d[g.parentTId] = i === null ? e.getRoot(c) : g.getParentNode()
                        }
                        f.hideNode(c, g, b)
                    }
                    for (var k in d)a = d[k][c.data.key.children], f.setFirstNodeForHide(c, a), f.setLastNodeForHide(c, a)
                }
            }, setFirstNode: function (c, a) {
                var b = c.data.key.children, d = a[b].length;
                ...
                var b, d, h, e, g;
                for (d = 0, h = a.length; d <
                h; d++)if (b = a[d], !e && !b.isHidden && b.isFirstNode) {
                    e = b;
                    break
                } else if (!e && !b.isHidden && !b.isFirstNode)b.isFirstNode = !0, e = b, f.setNodeLineIcos(c, b); else if (e && b.isFirstNode) {
                    b.isFirstNode = !1;
                    g = b;
                    f.setNodeLineIcos(c, b);
                    break
                ...
                var b, d, e, j;
                for (d = a.length - 1; d >=
                0; d--)if (b = a[d], !e && !b.isHidden && b.isLastNode) {
                    e = b;
                    break
                } else if (!e && !b.isHidden && !b.isLastNode)b.isLastNode = !0, e = b, f.setNodeLineIcos(c, b); else if (e && b.isLastNode) {
                    b.isLastNode = !1;
                    j = b;
                    f.setNodeLineIcos(c, b);
                    break
    ...
    var k = i.fn.zTree, t = k._z.tools, l = k.consts, f = k._z.view, e = k._z.data;
    e.addInitNode(function (c, a, b) {
        if (typeof b.isHidden == "string")b.isHidden = t.eqs(b.isHidden, "true");
        b.isHidden = !!b.isHidden;
        e.initHideForExCheck(c, b)
    });
    e.addBeforeA(function () {
    });
    e.addZTreeTools(function (c,
                              a) {
        ...
        var b = a.checkNode;
        if (b)a.checkNode = function (c, e, f, g) {
            (!c || !c.isHidden) && b.apply(a, arguments)
        }
    });
    var m = e.initNode;
    e.tmpHideParent = -1;
    e.initNode = function (c, a, b, d, h, j, g) {
        if (e.tmpHideParent !== d) {
            e.tmpHideParent = d;
            var i = (d ? d : e.getRoot(c))[c.data.key.children];
            e.tmpHideFirstNode = f.setFirstNodeForHide(c, i);
            e.tmpHideLastNode =
                f.setLastNodeForHide(c, i);
            f.setNodeLineIcos(c, e.tmpHideFirstNode);
            f.setNodeLineIcos(c, e.tmpHideLastNode)
        }
        h = e.tmpHideFirstNode === b;
        j = e.tmpHideLastNode === b;
        m && m.apply(e, arguments);
        j && f.clearOldLastNode(c, b)
    };
    var n = e.makeChkFlag;
    if (n)e.makeChkFlag = function (c, a) {
        (!a || !a.isHidden) && n.apply(e, arguments)
    };
    var o = e.getTreeCheckedNodes;
    if (o)e.getTreeCheckedNodes = function (c, a, b, d) {
        if (a && a.length > 0) {
    ...
    var p = e.getTreeChangeCheckedNodes;
    if (p)e.getTreeChangeCheckedNodes = function (c, a, b) {
        if (a && a.length > 0) {
    ...
    var q = f.expandCollapseSonNode;
    if (q)f.expandCollapseSonNode = function (c, a, b, d, e) {
        (!a || !a.isHidden) && q.apply(f, arguments)
    };
    var r = f.setSonNodeCheckBox;
    if (r)f.setSonNodeCheckBox = function (c, a, b, d) {
        (!a || !a.isHidden) && r.apply(f, arguments)
    };
    var s = f.repairParentChkClassWithSelf;
    if (s)f.repairParentChkClassWithSelf = function (c, a) {
