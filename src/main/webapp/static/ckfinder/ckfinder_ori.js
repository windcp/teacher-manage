...
(function () {
    ...
    (function () {
        ...
        var u = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'], v = ['Node', "\155\x65\163\163\x61\x67\145"];
                    ...
                    if (y == 'mouseup') {
                        ...
                        x.oW('beforeDroppable', C, function N(E, F) {
                            ...
                            try {
                                ...
                                }), J = window.top[a.nd + "\143\x61\164\151\157\x6e"][a.jG + "\x73\x74"], K = new a.iD(x.app, 'moveFilesToFolderDrop', {
                ...
                q.bD('FolderPasteMoveBasket', {
                    exec: function (w) {
                        if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(r) != a.lS(a.ed) || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) {
                            w.msgDialog("", "\124\x68\x69\x73\x20\146\x75\156\x63\x74\x69\157\x6e\x20\151\x73\x20\x64\151\163\141\x62\x6c\145\x64\040\151\156\x20\164\x68\x65\x20\x64\145\x6d\157\040\166\x65\x72\163\151\x6f\156\040\x6f\x66\x20\x43\x4b\x46\151\x6e\144\145\x72\x2e\074\x62\x72\x20\057\076\120\154\145\141\163\145\x20\x76\151\163\151\164\x20\x74\x68\x65\040\x3c\x61\x20\150\162\x65\146\075\047\150\164\164\x70\072\x2f\057\143\x6b\x66\x69\156\144\x65\x72\056\143\x6f\x6d\x27\076\x43\113\106\x69\x6e\x64\145\x72\040\167\145\x62\x20\163\x69\164\145\074\057\141\076\040\x74\157\040\x6f\x62\164\x61\151\x6e\040\x61\040\x76\x61\x6c\x69\144\x20\154\151\x63\145\156\x73\145\056")
                        } else {
                            var x = w.aV;
                            if (!x) {
                                return
    ...
    (function () {
        ...
        i.extend(n.dialog, {
            dD: function (w, x, y, z) {
                ...
                if (x.validate)this.validate = x.validate;
                var A = function () {
                    var B = i.extend({}, x, {id: x.id ? x.id + '_checkbox' : i.getNextNumber() + '_checkbox'}, true), C = [], D = {
                ...
                var z = [], A = this, B = function () {
                    ...
                    for (var G = 0; G < x.items.length; G++) {
                        var H = x.items[G], I = H[2] !== undefined ? H[2] : H[0], J = H[1] !== undefined ? H[1] : H[0], K = i.extend({}, x, {
                            ...
                            title: null,
                            type: null
                        }, true), L = i.extend({}, K, {id: null, title: I}, true), M = {
                            type: 'radio',
    ...
    a.gc.add('default', (function () {
        return {
            dQ: function (p) {
                ...
                var t = p.oW('themeSpace', {space: 'head', html: ''}), u = p.oW('themeSpace', {
                    space: 'sidebar',
                    html: ''
                }), v = p.oW('themeSpace', {space: 'mainTop', html: ''}), w = p.oW('themeSpace', {
                    space: 'mainMiddle',
                    html: ''
                }), x = p.oW('themeSpace', {
                    space: 'mainBottom',
