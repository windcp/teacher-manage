...
function Hui_admin_tab(obj){
	var bStop = false,
		...
		firstMenuName = $(obj).attr("data-first"),
		secondMenuName = $(obj).attr("data-second"),
	...
	if(!bStop){
		creatIframe(href,title,firstMenuName,secondMenuName);
		min_titleList();
	}
	else{
...
/*创建iframe*/
function creatIframe(href,titleName,firstMenuName,secondMenuName){
	var topWindow=$(window.parent.document),
		show_nav=topWindow.find('#min_title_list'),
		iframe_box=topWindow.find('#iframe_box'),
	...
	iframeBox.hide();
	iframe_box.append('<div class="show_iframe"><div class="loading"></div><iframe frameborder="0" data-first='+firstMenuName+' data-second='+secondMenuName+' src='+href+'></iframe></div>');
