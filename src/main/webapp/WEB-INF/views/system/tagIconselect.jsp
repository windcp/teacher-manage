...
<head>
    ...
    <style type="text/css">
		...
		.icon_lists li:hover{background: #D4D4D4;cursor: pointer;}
		.bg-lightGreen{background: lightgreen !important;}
    </style>
    <script type="text/javascript">
	    $(document).ready(function(){
	    	$("#icons li").click(function(){
	    		$("#icons li").removeClass("bg-lightGreen");
	    		$("#icons li i").removeClass("bg-lightGreen");
	    		$(this).addClass("bg-lightGreen");
	    		$("#icon").val($(this).children("i").text());
	    	});
	    	$("#icons li i").each(function(){
	    		if ($(this).text()=="${value}"){
	    			$(this).click();
	    		}
	    	});
