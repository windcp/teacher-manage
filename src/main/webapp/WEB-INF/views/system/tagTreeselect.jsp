...
<body>
	...
	<div id="search" class="form-search hide" style="padding:10px 0 0 13px;">
		...
		<input type="text" class="input-text" id="key" name="key" maxlength="50" style="width:110px;">
		<button id="btn" class="btn btn-primary raduis size-M" onclick="searchNode()">搜索</button>
	</div>
