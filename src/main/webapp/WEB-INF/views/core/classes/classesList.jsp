...
<head>
    ...
    <script type="text/javascript">
        ...
        function save(id){
            var title = '编辑';
            var url = "${ctx}/classes/form?id="+id;
            layer_show_full(title,url);
        }
        ...
        function initTable(){
            var url ="${ctx}/classes/getTableData" ;
...
<div class="page-container">
    <div class="text-c">
        <form class="Huiform">
            &nbsp;&nbsp;&nbsp;&nbsp;
            描述: <input type="text" class="input-text" style="width:200px" placeholder="班级名称" id="classesName" name="classesName">
            <button type="button" class="btn btn-success" id="search_btn"><i class="Hui-iconfont">&#xe665;</i> 搜索</button>
        </form>
    </div>
    <div class="table-box">
        <shiro:hasPermission name="sys:user:edit">
            <div class="cl pd-5 bg-1 bk-gray"> <span class="l"> <a class="btn btn-primary radius" href="javascript:;" id="add_btn"><i class="Hui-iconfont">&#xe600;</i> 添加班级</a> </span> </div>
        </shiro:hasPermission>
