...
<script type="text/javascript">
    $("#${id}Name").click(function () {
        ...
        var content = '${ctx}/tag/treeselect?url=' + encodeURIComponent("${url}") + '&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}';
        layer.open({
            type: 2,
            fix: false, //不固定
            title: '${title}',
            ...
            yes:function(index,layero){
                ...
                if (typeof ${id}TreeselectCallBack == 'function') {
                    ${id}TreeselectCallBack(index,layero);
                }
                layer.close(index);
            },
            btn2:function(){}
